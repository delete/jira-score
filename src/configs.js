...
const url = ( startDate='2017-06-01', endDate='2017-06-30', user=config.login ) => 
    _url() + encodeURI(`?jql=category = Cirrus AND "Dificuldade de Implementação" is not EMPTY AND resolution = Resolvido AND assignee = ${user} AND resolved >= ${startDate} AND resolved <= "${endDate} 23:59" ORDER BY cf[17132] ASC, resolved DESC&fields=assignee,project,customfield_21711,issuetype,timespent,customfield_17132&maxResults=200`)
